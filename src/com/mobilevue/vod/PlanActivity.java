...
import com.mobilevue.utils.CustomExpandableListAdapter;
...
public class PlanActivity extends Activity {
	...
	/*public void radioBtn_OnClick(View v) {
		((RadioButton) PlanActivity.this.findViewById(R.id.plan_list_plan_rb))
				.setChecked(false);
		((RadioButton) v).setChecked(true);
		selectedGroupItem = (Integer) v.getTag();
	}*/
